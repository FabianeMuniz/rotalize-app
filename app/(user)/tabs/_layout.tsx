...
export default function TabsLayout() {
  ...
  return (
    ...
    >
      {/* 1) INÍCIO -> aponta para app/(user)/tabs/home.tsx */}
      <Tabs.Screen
        name="home"
        options={{
          title: "Início",
      ...
      {/* 2) CONTA -> crie app/(user)/tabs/conta.tsx */}
      <Tabs.Screen
        name="account"
        options={{
          title: "Conta",
          tabBarIcon: ({ color, size }) => <Feather name="user" size={30} color={color} />,
        }}
      />

      {/* 3) CONFIGURAÇÃO -> crie app/(user)/tabs/configuracao.tsx */}
      <Tabs.Screen
        name="settings"
        options={{
          title: "Configuração",
